...
namespace AplicationDesktop1.Abm_Usuarios
{
    public partial class AltaUsuariosForm : Form
    {
        ...
        private void LimpiarButton_Click(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < this.CheckedListBox.Items.Count; i++)
            {
                this.CheckedListBox.SetItemCheckState(i, CheckState.Unchecked);
        ...
        {
            string Consulta = "SELECT nombre FROM ingeniar.Funcionalidades";
            List<SqlParameter> param = new List<SqlParameter>();
